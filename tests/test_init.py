...
from custom_components.dominionsc import async_setup_entry, async_unload_entry, update_listener
...
async def test_async_setup_entry(hass: HomeAssistant, mock_coordinator: MagicMock) -> None:
    ...
    with patch("custom_components.dominionsc.DominionSCCoordinator", return_value=mock_coordinator), \
